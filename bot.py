...
async def remove_username(new_List):
    for i in new_List:
        if('@' in i or 't.me' in i or 'https://bit.ly/abcd' in i or 'https://bit.ly/123abcd' in i or 'telegra.ph' in i or 'Streamtape' in i or 'Dropgalaxy' in i or 'dropgalaxy.in' in i or 'streamta.pe' in i):
            new_List.remove(i)
    return new_List
